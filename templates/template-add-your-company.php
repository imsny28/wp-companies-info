    ...
    <form action="" method="post" id="add_company_form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <select id="industry" class="ember-view" name="industry" class="form-control">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          ...
          <div class="row">
            <div class="col-sm-12">
              <input type="text" placeholder="Street Address*" name="address" id="address" class="form-control" required>
            </div>
          </div>
        </br>
          <div class="row">
            ...
            <div class="col-sm-12 col-sm-4">
              <select id="state" class="state-class" name="state" class="form-control">
            ...
            <div class="col-sm-12 col-sm-4">
              <input type="text" placeholder="Zip Code*" name="zip_code" id="zip_code" maxlength="6"  class="form-control" required>
            </div>
        </div>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12 col-sm-6">
          <input type="text"  name="phone_number" id="phone_number" placeholder="Phone Number* :987-234-4444" maxlength="12" class="form-control" required>
        </div>
        <div class="col-sm-12 col-md-6">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          <input type="text"  name="companywebsite" id="companywebsite" class="form-control" placeholder="Company Website*" required>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12">
          <label for="bussinessdescription"><b>Business Description* :</b></label>
          <textarea rows="4" cols="50" name="bussiness_description" id="bussiness_description" class="form-control" required></textarea>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12">
      ...
      <div class="form-group button_row ">
        <div class="clearfix">
          <input type="submit" name="submit" value="Submit" id="add_company_button" class="btn btn-success">
        </div>
      </div>
    </form>
  </div>
